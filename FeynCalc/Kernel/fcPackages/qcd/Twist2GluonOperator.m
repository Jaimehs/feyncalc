...
Twist2GluonOperator /:
   MakeBoxes[
             ...
             RowBox[
 {SubSuperscriptBox["O",
                     RowBox[{FeynCalc`Tbox[m1],"\[VeryThinSpace]", 
                             FeynCalc`Tbox[m2]}], "G2"
                    ],
  RowBox[{"("}],
  FeynCalc`Tbox[p1], "," ,FeynCalc`Tbox[p2],
  RowBox[{")"}]
 }                 ];
...
Twist2GluonOperator /:
   MakeBoxes[
             ...
             RowBox[
 {SubSuperscriptBox["O",
                     RowBox[{FeynCalc`Tbox[mu],"\[VeryThinSpace]", FeynCalc`Tbox[nu]}
                           ], "G2"
                    ],
  RowBox[{"("}],
  FeynCalc`Tbox[p],
...
Twist2GluonOperator /:
   MakeBoxes[
             ...
             RowBox[
 {SubSuperscriptBox["O",
                     RowBox[ {FeynCalc`Tbox[m1],"\[VeryThinSpace]", FeynCalc`Tbox[m2],
                             "\[VeryThinSpace]", FeynCalc`Tbox[m3]}
                           ], "G3"
                    ],
  RowBox[{"("}],
  FeynCalc`Tbox[p1],",",FeynCalc`Tbox[p2],",",FeynCalc`Tbox[p3],
  RowBox[{")"}]
 }                 ];
...
Twist2GluonOperator /:
 ...
 {SubSuperscriptBox["O",
             RowBox[ {FeynCalc`Tbox[m1],"\[VeryThinSpace]", FeynCalc`Tbox[m2],
                      "\[VeryThinSpace]", FeynCalc`Tbox[m3],
                      "\[VeryThinSpace]", FeynCalc`Tbox[m4]
                     }
                   ], "G4"
                    ],
  RowBox[{"("}],
  FeynCalc`Tbox[p1],",",FeynCalc`Tbox[p2],",",FeynCalc`Tbox[p3],",",FeynCalc`Tbox[p4],
  RowBox[{")"}]      
 }                 ];
