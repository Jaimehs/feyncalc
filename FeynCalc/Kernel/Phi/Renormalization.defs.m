...
RowBox[Join[Table[
            UnderoverscripFeynCalc`Tbox["\[Integral]",
...
FeynmanX /: MakeBoxes[FeynmanX[i_], TraditionalForm] :=
    SubscripFeynCalc`Tbox[MakeBoxes[StyleForm["x", FontSlant -> "Italic"]][[1]],
      MakeBoxes[TraditionalForm[i]]];

FeynmanY /: MakeBoxes[FeynmanY[i_], TraditionalForm] :=
    SubscripFeynCalc`Tbox[MakeBoxes[StyleForm["y", FontSlant -> "Italic"]][[1]],
      MakeBoxes[TraditionalForm[i]]];

FeynmanZ /: MakeBoxes[FeynmanZ[i_], TraditionalForm] :=
    SubscripFeynCalc`Tbox[MakeBoxes[StyleForm["z", FontSlant -> "Italic"]][[1]],
      MakeBoxes[TraditionalForm[i]]];
...
VeltmanB0 /: MakeBoxes[VeltmanB0, TraditionalForm] := SubscripFeynCalc`Tbox["B", "0"];
VeltmanB0 /: MakeBoxes[VeltmanB0[x__, __Rule], TraditionalForm] := 
    MakeBoxes[TraditionalForm[VeltmanB0[x]]];

VeltmanC0 /: MakeBoxes[VeltmanC0, TraditionalForm] := SubscripFeynCalc`Tbox["C", "0"];
VeltmanC0 /: MakeBoxes[VeltmanC0[x__, __Rule], TraditionalForm] := 
    MakeBoxes[TraditionalForm[VeltmanC0[x]]];

VeltmanD0 /: MakeBoxes[VeltmanD0, TraditionalForm] := SubscripFeynCalc`Tbox["D", "0"];
